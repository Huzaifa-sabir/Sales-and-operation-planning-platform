...
class Settings(BaseSettings):
    ...
    # Database
    MONGODB_URL: str = "mongodb+srv://huzaifasabir289_db_user:4SLjzoPzm00pQNNv@cluster0.4owv6bf.mongodb.net/sop_portal?retryWrites=true&w=majority&ssl=true&ssl_cert_reqs=CERT_NONE"
